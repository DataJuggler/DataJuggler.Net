...
namespace DataJuggler.Net
{
    ...
    public class CSharpClassWriter
    {
        ...
        private void WriteCreateTableMethod(DataJuggler.Net.DataTable table)
        {
            ...
            line = "DataJuggler.Net.DataField field = new DataJuggler.NetDataField();";
            WriteLine(line);
        ...
        public void WriteReferences(ReferencesSet references, bool requireDelegatesReference = false)
        {
            ...
            try
            {
                ...
                if ((requireDelegatesReference) && (!hasDelegateReference))
                {
                    ...
                    // write out the reference for DataJuggler.Net.Delegates
                ...
                if ((requireDelegatesReference) && (!hasEnumerationsReference))
                {
                    ...
                    // write out the reference for DataJuggler.Net.Enumerations
                    WriteReference(referenceObject);
                }
